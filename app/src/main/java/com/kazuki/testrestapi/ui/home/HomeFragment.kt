...
import com.kazuki.testrestapi.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val data = homeViewModel.apiUserRes.observe(viewLifecycleOwner) {
            val data = ArrayList(it)
            userAdapter.inputDataToAdapter(data)
        }
